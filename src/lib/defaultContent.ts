...
export const defaultCases: CaseStudy[] = [
  ...
  },
  {
    ...
    lessons:
      "Scale changes what quality means. On one article, quality is judgment. Across 250 selectors and 300 assets, quality is whether the system makes the wrong thing hard to publish. The score held because the process caught things, not because anyone was reading more carefully than they had before.",
  },
  {
  ...
  },
  {
    ...
    insight:
      "Nobody arrives at a help center through its front door. Every article is a landing page for someone who is already frustrated.",
    result:
    ...
    lessons:
      "The strongest help article is often the one that exists to stop the reader doing something, and it is the hardest to write, because it has to argue rather than instruct. Nobody arrives wanting to be told their instinct is wrong. Leading with the consequence to them rather than with the mechanism is the difference between an article that changes behavior and one that is skimmed and ignored.",
  },
  {
