...
|---|---|---|
| Insufficient funds | Not enough available balance | Pay from a different card, or retry after funds clear |
...
explained](/samples/payments-kb/decline-reasons), including what each one means
for whether trying again can work.
...
**Pay by bank transfer.** The details are at the bottom of your invoice. Use
the invoice number as the payment reference, or the transfer will arrive
...
- Your **invoice number**, beginning `INV-`
- The **exact decline message**, word for word
- The **date and rough time** of your last attempt
- The **last four digits** of the card. Never the full number.

With those four things we can usually find the attempt in our records on the
first look. Without them, the conversation starts with us asking for them.
