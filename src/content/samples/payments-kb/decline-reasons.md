...
Your account doesn't have enough available balance. Available balance isn't
the same as the number displayed in your banking app: money you've spent that
hasn't yet cleared is already committed against it.
...
The card is past its expiry date. This is worth checking even when you're sure,
...
One of the values didn't match: the card number, the expiry date, or the
...
The billing address you entered doesn't match the one your bank holds for the
card.

It must be the address on your **bank statement**, not your delivery address
and not your office. If you've moved recently and not told your bank, their
...
including the postcode. If you're unsure, your banking app shows it under your
profile or statement settings.

## Card declined

Your bank refused the payment and didn't tell us why.

This sounds unhelpful, and it is, but the silence is deliberate and it isn't
...
release it while you're on the phone.
...
Your bank doesn't allow this card to be used for this kind of payment. The
usual causes are a block on international payments, a block on online payments,
or a card type we can't accept.
...
different card. If they tell you the card type itself isn't supported, a
...
**Do this:** use a different card. If you didn't report it, call your bank
...
bank transfer, which isn't subject to card limits.

## Payment system unavailable

Something failed between us and the card networks. This isn't your card and
not your bank.

**Do this:** wait about ten minutes and try again. If it's still happening
after an hour, tell us, because at that point it's our problem to fix and we
may not know about it yet.

## What a decline is not

**It isn't a charge.** No money moved. You may see a pending authorization on
your statement for a few days; your bank releases it on its own schedule.

**It isn't a judgment about you.** Most declines are a bank's fraud system
being cautious about an unfamiliar merchant, which is the system working as
intended even when it's inconvenient.

**It doesn't cancel the invoice.** The invoice stays open and payable, and its
due date doesn't move because an attempt failed.
...
refused: it's written for your support staff, in English, and its wording is
